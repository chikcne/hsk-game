...
const vocabulary = [
  ["学习", "xuéxí", "xuexi", "to study; to learn"], ["你", "nǐ", "ni", "you"], ["好", "hǎo", "hao", "good"], ["电", "diàn", "dian", "electricity"],
  ["学校", "xuéxiào", "xuexiao", "school"], ["朋友", "péngyou", "pengyou", "friend"], ["爱", "ài", "ai", "to love"],
  ["水", "shuǐ", "shui", "water"], ["中国", "Zhōngguó", "zhongguo", "China"], ["老师", "lǎoshī", "laoshi", "teacher"],
  ...
  ["说", "shuō", "shuo", "to speak"], ["写", "xiě", "xie", "to write"],
  ["你好", "nǐhǎo", "nihao", "hello"], ["读", "dú", "du", "to read"], ["工作", "gōngzuò", "gongzuo", "to work; job"],
  ...
  ["电影院", "diànyǐngyuàn", "dianyingyuan", "cinema"],
] as const;
